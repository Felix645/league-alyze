...
class Settings extends Command
{
     ...
     * @var string
     */
    protected static $defaultName = 'db:settings';
    ...
    public function configure()
    {
        ...
        $this->setDescription('Creates a new migration for the framework settings table.');
    }
    ...
    public function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        $arguments = [
            ...
            'name'          => 'create_framework_settings_table',
            '--settings'    => true
        ];
