...
class RequiredUnlessMultiple extends Rule
{
    use hasRequiredCheck;

    protected $params = ['requiredUnlessMultiple'];
    ...
    public function check($field)
    {
        ...
        $params = explode(';', $this->field->getAttribute('requiredUnlessMultiple'));

        if( !isset($params[0]) ) {
            $message = "Missing rule params for {$this->field->getFieldName()}: requiredUnlessMultiple";
